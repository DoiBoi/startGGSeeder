...
players_df, entrants = iterate_through_tournament_series("ubc-fgc-frenzy-friday", 12, videogames=videogames)
elo_dataframes = generate_elo(players_df, entrants, videogames)
updated_elo = update_saved_elo(updated_elo, elo_dataframes)
save_game_elo_data(videogames, updated_elo)
...
players_df, entrants = iterate_through_tournament_array(["ubc-fgc-winter-wavedash-2", "cascadia-cup-road-to-bobc", "ubc-fgc-summer-slam-5"], videogames=videogames)
elo_dataframes = generate_elo(players_df, entrants, videogames)
updated_elo = update_saved_elo(updated_elo, elo_dataframes)
save_game_elo_data(videogames, updated_elo)
